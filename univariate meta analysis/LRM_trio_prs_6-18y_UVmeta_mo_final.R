...
output_dir <- "lrm_trio_prs_6-18y_mo_UVmeta_FE"  # Change directory name according to the statistical model
...
# Define the directory where you want to save the forest plot PNG files
output_dir <- "lrm_trio_prs_6-18y_mo_UVmeta_RE"  # Change directory name according to the statistical model
...
save(meta_results, file = "LRM_trio_prs_6-18y_mo_UVmeta.RData")

cat("Combined data and output results saved to 'LRM_trio_prs_6-18y_mo_UVmeta.RData'.\n") # Change file name according to the statistical model
...
write_csv(combined_data, "lrm_trio_prs_6-18y_mo_combined_studies.csv") # Change file name according to the statistical model

cat("Combined data saved to 'lrm_trio_prs_6-18y_mo_combined_studies.csv'.\n") # Change file name according to the statistical model
