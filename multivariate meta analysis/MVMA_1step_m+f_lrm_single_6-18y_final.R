...
output_dir <- "MVMA_FE_1step_m+f_lrm_sng_all_6-18y"
...
# Save results to CSV
output_file <- file.path(output_dir, "MVMA_FE_1step_lrm_sng_all_6-18y.csv")
...
save(meta_results, file = file.path(output_dir, "MVMA_FE_1step_lrm_sng_all_6-18y.RData")) # Change file name according to the model and cohort
 
cat("Meta-analysis objects saved as 'MVMA_FE_1step_lrm_sng_all_6-18y.RData'.\n")
...
# Define output directory
output_dir <- "MVMA_RE_1step_m+f_lrm_sng_all_6-18y"
...
# Save results to CSV
output_file <- file.path(output_dir, "MVMA_RE_1step_lrm_sng_all_6-18y.csv")
write.csv(final_results, file = output_file, row.names = FALSE)

cat("Final results saved to", output_file, "\n")

# Save the meta-analysis models & statistics for future use
save(meta_results, file = file.path(output_dir, "MVMA_RE_1step_lrm_sng_all_6-18y.RData")) # Change file name according to the model and cohort

cat("Meta-analysis objects saved as 'MVMA_RE_1step_lrm_sng_all_6-18y.RData'.\n")
...
write.csv(meta_data, "lrm_sng_6-18y_m+f_combined.csv") # Change file name according to the model and cohort

cat("Combined data saved to 'lrm_sng_6-18y_m+f_combined.csv'.\n")
