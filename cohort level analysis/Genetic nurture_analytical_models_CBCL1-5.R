...
# Create a new dataframe to store the pTDTds in CBCL1_5 (adjust these to your dataset's variable names if necessary)
...
# List of nonstandardized pTDTd variables in CBCL1_5 (adjust to your dataset's variable names)
...
write.csv(results_pTDTd, "one-sample_t_test_pTDTd_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
write.csv(significant_results_pTDTd, "one-sample_t_test_significant_pTDTd_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort

# Print plots for significant results
print("Boxplots of pTDTd One-sample T-test Significant Results for CBCL1_5:")

# Function to generate and save box plots for significant results
generate_boxplots <- function(variable, data) {
  
  if (!dir.exists("pTDTd_Boxplots_CBCL1_5")) {
    dir.create("pTDTd_Boxplots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
  }
  ...
  # Define a file name
  plot_filename <- paste("pTDTd_Boxplots_CBCL1_5", paste(variable, "boxplot_cbcl1_5.png", sep = "_"), sep = "/") # replace cbcl1_5 to specify your own cohort
...
# Define psychiatric PRSc variables in CBCL1_5 (adjust these to your dataset's variable names if necessary)
prs_13 <- c("MDD", "BD", "SCZ", "ADHD", "AN", "ASD", "NEUROT", "ANX", "OCD", "CDG", "PPD", "PTSD", "INSOM")
prs_vars_13 <- paste0("prs_c_qc_", prs_13, "_trio")
...
# write.csv(results_df_cbcl_c, "lrm_joint_PRSc_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# write.csv(significant_results_df_cbcl_c, "lrm_joint_PRSc_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort


# Create directories for Q-Q and Coefficient plots
if (!dir.exists("LRM_Joint_PRSs_QQ_Plots_CBCL1_5")) {
  dir.create("LRM_Joint_PRSs_QQ_Plots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
}
if (!dir.exists("LRM_Joint_PRSs_Coeff_Plots_CBCL1_5")) {
  dir.create("LRM_Joint_PRSs_Coeff_Plots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
}

# Print and save Q-Q plots for significant results
print("Q-Q Plots of LRM Joint PRSs Significant Results for CBCL1_5:")
print("Coefficient Plots of LRM Joint PRSs Significant Results for CBCL1_5:")

# Plot and save png files
plot_and_save_qq <- function(predictor_name, outcome_name, result) {
  png(paste0("LRM_Joint_PRSs_QQ_Plots_CBCL1_5/qq_PRSjoint_", predictor_name, "_", outcome_name, ".png"), width = 700, height = 500) # replace cbcl1_5 to specify your own cohort
  plot(result$qq_plot)
  dev.off()
  plot(result$qq_plot)
}
...
plot_and_save_coef <- function(predictor_name, outcome_name, result) {
  png(paste0("LRM_Joint_PRSs_Coeff_Plots_CBCL1_5/lrm_coeff_PRSjoint_", predictor_name, "_", outcome_name, ".png"), width = 700, height = 500) # replace cbcl1_5 to specify your own cohort
  plot(result$coef_plot)
  dev.off()
  plot(result$coef_plot)
}
...
# Change prs_vars_13 with PRSm variables in CBCL1_5 (adjust these to your dataset's variable names if necessary)
prs_vars_13 <- sub("prs_c_qc_", "prs_m_qc_", prs_vars_13)
...
# Save all regression results to a CSV file
# write.csv(results_df_cbcl_m, "lrm_joint_PRSm_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save significant regression results to a CSV file
# write.csv(significant_results_df_cbcl_m, "lrm_joint_PRSm_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Change prs_vars_13 with PRSf variables in CBCL1_5 (adjust these to your dataset's variable names if necessary)
prs_vars_13 <- sub("prs_m_qc_", "prs_f_qc_", prs_vars_13)
...
# write.csv(results_df_cbcl_f, "lrm_joint_PRSf_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# write.csv(significant_results_df_cbcl_f, "lrm_joint_PRSf_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
################################ Joint PRSnts LRM #################################
# Change prs_vars_13 with PRSnt variables in CBCL1_5 (adjust these to your dataset's variable names if necessary)
prs_vars_13 <- sub("prs_f_qc_", "prs_nt_qc_", prs_vars_13)
...
# Write regression results to a CSV file
# write.csv(results_df_cbcl_nt, "lrm_joint_PRSnt_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Write significant regression results to a CSV file
# write.csv(significant_results_df_cbcl_nt, "lrm_joint_PRSnt_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
################################ Joint pTDTds LRM #################################
# Change prs_vars_13 with pTDTd variables in CBCL1_5 (adjust these to your dataset's variable names if necessary)
prs_vars_13 <- sub("prs_nt_qc_", "pTDTd_qc_", prs_vars_13)
...
# Write regression results to a CSV file
# write.csv(results_df_cbcl_ptdtd, "lrm_joint_pTDTd_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Write significant regression results to a CSV file
# write.csv(significant_results_df_cbcl_ptdtd, "lrm_joint_pTDTd_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
write_xlsx(list(LinReg_joint_PRSc_cbcl1_5 = results_df_cbcl_c, LinReg_joint_PRSm_cbcl1_5 = results_df_cbcl_m, LinReg_joint_PRSf_cbcl1_5 = results_df_cbcl_f, LinReg_joint_PRSnt_cbcl1_5 = results_df_cbcl_nt, LinReg_joint_pTDTd_cbcl1_5 = results_df_cbcl_ptdtd), path = "lrm_joint_PRSs_summary_cbcl1_5.xlsx") # replace cbcl1_5 to specify your own cohort

# Combine and save significant joint linear regression results to an xlsx file
write_xlsx(list(LinReg_joint_PRSc_cbcl1_5 = significant_results_df_cbcl_c, LinReg_joint_PRSm_cbcl1_5 = significant_results_df_cbcl_m, LinReg_joint_PRSf_cbcl1_5 = significant_results_df_cbcl_f, LinReg_joint_PRSnt_cbcl1_5 = significant_results_df_cbcl_nt, LinReg_joint_pTDTd_cbcl1_5 = significant_results_df_cbcl_ptdtd), path = "lrm_joint_PRSs_significant_cbcl1_5.xlsx") # replace cbcl1_5 to specify your own cohort
...
# Define psychiatric PRSc variables for CBCL1_5 (adjust these to your dataset's variable names if necessary)
prs_13 <- c("MDD", "BD", "SCZ", "ADHD", "AN", "ASD", "NEUROT", "ANX", "OCD", "CDG", "PPD", "PTSD", "INSOM")
prs_vars_13 <- paste0("prs_c_qc_", prs_13, "_trio")
...
logistic_regression_joint <- function(data, prs_vars_13, covariates) {
  formula <- as.formula(paste("h_c_total_cat_1_5y", "~", paste(c(prs_vars_13, covariates), collapse = "+")))
...
# write.csv(results_logr_df_joint_c, "logr_joint_PRSc_summary_cbcl1_5.csv", row.names=FALSE)
...
# Save significant logistic regression results to a csv file
# write.csv(significant_results_logr_df_joint_c, "logr_joint_PRSc_significant_cbcl1_5.csv", row.names = FALSE)

# Ensure directories exist
if (!dir.exists("LogR_Joint_PRSs_CM_Plots_CBCL1_5")) {
  dir.create("LogR_Joint_PRSs_CM_Plots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
}
if (!dir.exists("LogR_Joint_PRSs_ROC_Plots_CBCL1_5")) {
  dir.create("LogR_Joint_PRSs_ROC_Plots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
}
if (!dir.exists("LogR_Joint_PRSs_Coeff_Plots_CBCL1_5")) {
  dir.create("LogR_Joint_PRSs_Coeff_Plots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
}

# Print plots for significant results 
print("Plots of LogR Joint PRS Significant Results for CBCL1_5:")

# Function to process and plot significant logistic regression results
process_and_plot_results <- function(predictor_name, results) {
  # Plot and save confusion matrix
  cm_data <- as.data.frame(results$confusion_matrix)
  png(paste0("LogR_Joint_PRSs_CM_Plots_CBCL1_5/cm_PRSjoint_", predictor_name, "_h_c_total_cat_cbcl1_5y", ".png"), width = 700, height = 500) # replace cbcl1_5 to specify your own cohort
  plot(as.factor(cm_data$Prediction), as.factor(cm_data$Reference), col = cm_data$Freq, main = paste("Confusion Matrix for", predictor_name))
  dev.off()
  plot(as.factor(cm_data$Prediction), as.factor(cm_data$Reference), col = cm_data$Freq, main = paste("Confusion Matrix for", predictor_name))

  # Plot and save ROC Curve
  png(paste0("LogR_Joint_PRSs_ROC_Plots_CBCL1_5/roc_PRSjoint_", predictor_name, "_h_c_total_cat_cbcl1_5y", ".png"), width = 700, height = 500) # replace cbcl1_5 to specify your own cohort
  plot(results$roc_obj, main = paste("ROC Curve for", predictor_name))
  dev.off()
  plot(results$roc_obj, main = paste("ROC Curve for", predictor_name))
  ...
  coef_plot <- ggplot(coef_df, aes(x = Predictor, y = Estimate)) +
    ...
    theme_minimal() +
    coord_flip() +  # Flip the coordinates for better readability
    ggtitle(paste("Coefficient Plot of LogR for PRSjoint:", predictor_name, "on h_c_total_cat_cbcl1_5y")) +
    ylab("Estimate") +
    xlab("Predictor")

  # Save the coefficient plot
  png(paste0("LogR_Joint_PRSs_Coeff_Plots_CBCL1_5/logr_coeff_PRSjoint_", predictor_name, "_h_c_total_cat_cbcl1_5y", ".png"), width = 700, height = 500) # replace cbcl1_5 to specify your own cohort
  print(coef_plot)
  dev.off()
  print(coef_plot)
}
...
# write.csv(results_logr_df_joint_m, "logr_joint_PRSm_summary_cbcl1_5.csv", row.names=FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save significant regression results to a csv file
# write.csv(significant_results_logr_df_joint_m, "logr_joint_PRSm_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save logistic regression results to a csv file
# write.csv(results_logr_df_joint_f, "logr_joint_PRSf_summary_cbcl1_5.csv", row.names=FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save significant logistic regression results to a csv file
# write.csv(significant_results_logr_df_joint_f, "logr_joint_PRSf_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save logistic regression results to a csv file
# write.csv(results_logr_df_joint_nt, "logr_joint_PRSnt_summary_cbcl1_5.csv", row.names=FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save significant logistic regression results to a csv file
# write.csv(significant_results_logr_df_joint_nt, "logr_joint_PRSnt_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save logistic regression results to a csv file
# write.csv(results_logr_df_joint_ptdtd, "logr_joint_pTDTd_summary_cbcl1_5.csv", row.names=FALSE) # replace cbcl1_5 to specify your own cohort
...
# Save significant logistic regression results to a csv file
# write.csv(significant_results_logr_df_joint_ptdtd, "logr_joint_pTDTd_significant_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
write_xlsx(list(LogReg_joint_PRSc_cbcl1_5 = results_logr_df_joint_c, LogReg_joint_PRSm_cbcl1_5 = results_logr_df_joint_m, LogReg_joint_PRSf_cbcl1_5 = results_logr_df_joint_f, LogReg_joint_PRSnt_cbcl1_5 = results_logr_df_joint_nt, LogReg_joint_pTDTd_cbcl1_5 = results_logr_df_joint_ptdtd), path = "logr_joint_PRSs_summary_cbcl1_5.xlsx") # replace cbcl1_5 to specify your own cohort

# Combine and save significant joint logistic regression results to an xlsx file
write_xlsx(list(LogReg_joint_PRSc_cbcl1_5 = significant_results_logr_df_joint_c, LogReg_joint_PRSm_cbcl1_5 = significant_results_logr_df_joint_m, LogReg_joint_PRSf_cbcl1_5 = significant_results_logr_df_joint_f, LogReg_joint_PRSnt_cbcl1_5 = significant_results_logr_df_joint_nt, LogReg_joint_pTDTd_cbcl1_5 = significant_results_logr_df_joint_ptdtd), path = "logr_joint_PRSs_significant_cbcl1_5.xlsx") # replace cbcl1_5 to specify your own cohort
...
#library(ggplot2)
# 
# Factorize the child subgroups based on 'h_c_total_cat_1_5y'
data$group <- factor(data$h_c_total_cat_1_5y, levels = c(0, 1), labels = c("Normal", "Borderline"))
...
# Print plots for significant results
print("Boxplots of ANCOVA Subgroup PRS Significant Results for CBCL1_5:")

# Create a directory for saving boxplots
if (!dir.exists("PRS_Subgroup_ANCOVA_Boxplots_CBCL1_5")) {
  dir.create("PRS_Subgroup_ANCOVA_Boxplots_CBCL1_5") # replace CBCL1_5 in the directory name to specify your own cohort
}
...
save_boxplot <- function(data, prs_var) {
  ...
  plot_filename <- paste0("PRS_Subgroup_ANCOVA_Boxplots_CBCL1_5/ancova_subgroup_boxplot_", prs_var, "_cbcl1_5", ".png") # replace cbcl1_5 to specify your own cohort
...
# write.csv(results_c, "ancova_subgroup_child_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_m, "ancova_subgroup_maternal_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_f, "ancova_subgroup_paternal_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_nt, "ancova_subgroup_non_transmitted_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_pTDTd, "ancova_subgroup_pTDTd_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
# write.csv(results_c, "ancova_subgroup_significant_child_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_m, "ancova_subgroup_significant_maternal_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_f, "ancova_subgroup_significant_paternal_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_nt, "ancova_subgroup_significant_non_transmitted_prs_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
# write.csv(results_pTDTd, "ancova_subgroup_significant_pTDTd_cbcl1_5.csv", row.names = FALSE) # replace cbcl1_5 to specify your own cohort
...
write_xlsx(list(ANCOVA_PRSc_CBCL1_5_subgrp = results_c, ANCOVA_PRSm_CBCL1_5_subgrp = results_m, ANCOVA_PRSf_CBCL1_5_subgrp = results_f, ANCOVA_PRSnt_CBCL1_5_subgrp = results_nt, ANCOVA_pTDTd_CBCL1_5_subgrp = results_pTDTd), path = "ancova_subgroup_prs_summary_cbcl1_5.xlsx") # replace cbcl1_5 to specify your own cohort
write_xlsx(list(ANCOVA_PRSc_CBCL1_5_subgrp = results_significant_c, ANCOVA_PRSm_CBCL1_5_subgrp = results_significant_m, ANCOVA_PRSf_CBCL1_5_subgrp = results_significant_f, ANCOVA_PRSnt_CBCL1_5_subgrp = results_significant_nt, ANCOVA_pTDTd_CBCL1_5_subgrp = results_significant_pTDTd), path = "ancova_subgroup_significant_prs_cbcl1_5.xlsx") # replace cbcl1_5 to specify your own cohort
